...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Conheça o Serviço de Acolhimento em Família Acolhedora do Lar Franciscano de Piracicaba e saiba como participar." },
      { name: "twitter:description", content: "Conheça o Serviço de Acolhimento em Família Acolhedora do Lar Franciscano de Piracicaba e saiba como participar." },
